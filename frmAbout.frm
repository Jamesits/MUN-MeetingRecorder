...
Private Sub Form_Load()
    ...
    lblVersion.Caption = "版本 " & getVersionString
    lblTitle.Caption = App.Title
    lblDisclaimer.Caption = "Model United Nation Meeting Recorder by James Swineson is licensed under a Creative Commons 署名-非商业性使用-相同方式共享 2.5 中国大陆 License基于sourceforge.net上的作品创作。"
    lblDescription.Caption = "A simple but fully-functioned meeting recorder.Still developing."
End Sub
